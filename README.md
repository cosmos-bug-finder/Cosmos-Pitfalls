...
- [Evmos/ethermint](./high-light-findings/evm-ethermint) - `Evmos/ethermint` is a widely used evm module in Cosmos ecosystem, including Cronos($3.13B), Injective($310M), Mantra($71.84M), K***($61M), Zeta($71M) and so on.([CVE](https://www.cve.org/CVERecord?id=CVE-2021-25837))
...
| 29 |  | [K***](https://github.com/K***-Labs/K***) | Mock | [K***#2077](https://github.com/K***-Labs/K***/issues/2077) | - | EVM | [Acknowledged](https://github.com/K***-Labs/K***/issues/2077) | [Private Credit](./record/acknowledgments/K***.md) |
...
| 37 |  | [H*** Core](https://github.com/H***-network/H***-core) | Mock | [H***-core#36](https://github.com/H***-network/H***-core/issues/36) | - | EVM | [Acknowledged](https://github.com/H***-network/H***-core/issues/36) | [Issue Credit](https://github.com/H***-network/H***-core/issues/36) |
| 38 |  | [LambdaVM](https://github.com/LambdaIM/lambdavm) | Mock | [lambdavm#255](https://github.com/LambdaIM/lambdavm/issues/255) | - | EVM | - | - |
| 39 |  | [G***](https://github.com/GPTx-global/G***) | Mock | [G***-v1#32](https://github.com/G***finglobal/G***-v1/issues/32) | - | EVM | [Acknowledged](https://github.com/G***finglobal/G***-v1/issues/32) | [Issue Credit](https://github.com/G***finglobal/G***-v1/issues/32) |
...
| 64 |  | [Uptick](https://github.com/UptickNetwork/uptick) | Full Chain | [app.go#L89-L96](https://github.com/UptickNetwork/uptick/blob/main/app/app.go#L89-L96) | - | Evm & Wasm | ✅ [Fixed](https://github.com/UptickNetwork/uptick/releases/tag/v0.3.1) | [Release Credit](https://github.com/UptickNetwork/uptick/releases/tag/v0.3.1) |
| 65 |  | [Althea](https://github.com/AltheaFoundation/althea-L1) | Full Chain | [Advisory](https://github.com/AltheaFoundation/althea-L1/security/advisories/GHSA-4p8x-4fh4-2cj3) | - | Evm & Wasm | ✅ [Fixed](https://github.com/AltheaFoundation/althea-L1/commit/ced08fcbdb5c0c1f2b16fa79c62cd0301c64ad91) | [Evident](https://github.com/cosmos-bug-finder/Cosmos-Pitfalls/blob/main/record/acknowledgments/althea.md) |
...
| | artela | brcchain | bridgeless | cosmos-evm | cvn | de-evm | egorasmarket | G*** | H*** | hetu | irishub | K*** | lambdavm | mezod | mtt | ollo | planq | rarimo | rollup-evm | ssc | stride | tenet | uptick | xtelabs |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| **G***** | 0.607 | 0.9378 | 0.9862 | 0.7064 | 0.9566 | 0.9505 | 0.9284 | 1.0 | 0.8571 | 0.9552 | 0.4227 | 0.9572 | 0.724 | 0.7873 | 0.9355 | 0.0617 | 0.9529 | 0.9424 | 0.9378 | 0.0967 | 0.0614 | 0.963 | 0.1322 | 0.9285 |
| **H***** | 0.5735 | 0.8193 | 0.8519 | 0.7618 | 0.8571 | 0.8552 | 0.8469 | 0.8571 | 1.0 | 0.8394 | 0.3748 | 0.8383 | 0.6499 | 0.6966 | 0.8193 | 0.0616 | 0.8326 | 0.8239 | 0.8193 | 0.1002 | 0.0613 | 0.8389 | 0.132 | 0.8314 |
...
| **K***** | 0.6002 | 0.9593 | 0.964 | 0.6932 | 0.955 | 0.9372 | 0.9107 | 0.9572 | 0.8383 | 0.935 | 0.4256 | 1.0 | 0.7246 | 0.7719 | 0.9616 | 0.0629 | 0.9652 | 0.9616 | 0.9593 | 0.0983 | 0.0625 | 0.9389 | 0.1342 | 0.936 |
...
| G*** Network | [https://G***network.ai/staking](https://G***network.ai/staking) |
...
| **P5 related EVM chains**                   | **Excluded.** These chains reused the affected EVMOS code only after P5 had already been fixed in the upstream dependency. Examples include [Cronos](https://coinmarketcap.com/currencies/cronos/), [Injective](https://coinmarketcap.com/currencies/injective/), [K***](https://coinmarketcap.com/currencies/K***/), [ZetaChain](https://coinmarketcap.com/currencies/zetachain/), and [MANTRA](https://coinmarketcap.com/currencies/mantra/). |
...
*This research contributes to the security and robustness of the Cosmos ecosystem by identifying common pitfalls and promoting secure development practices across blockchain projects. Finally, we emphasize that our goal is not merely vulnerability detection, but the development of a structured taxonomy of customizable operations within the transaction lifecycle and the identification of concrete security pitfalls. We believe these insights can serve as a foundation for future static analysis tool development tailored specifically to the Cosmos ecosystem. I would also like to express my sincere gratitude to my close friend [iczc](https://www.iczc.me/), the third author of this paper and the discoverer of the P5 vulnerability, which I consider one of the most fascinating vulnerabilities in the world. This discovery was one of the motivations behind our work. He was also the person who first guided me into the world of blockchain security.*
