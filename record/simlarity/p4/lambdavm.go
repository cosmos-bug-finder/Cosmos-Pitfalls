...
import (
	...
	ethermint "github.com/LambdaIM/lambdavm/types"
	"github.com/LambdaIM/lambdavm/x/evm/statedb"
	"github.com/LambdaIM/lambdavm/x/evm/types"
...
func (k *Keeper) ApplyMessageWithConfig(ctx sdk.Context, msg core.Message, tracer vm.EVMLogger, commit bool, cfg *types.EVMConfig, txConfig statedb.TxConfig) (*types.MsgEthereumTxResponse, error) {
	...
	// for more info https://github.com/LambdaIM/lambdavm/issues/1085
